...
function showHeatMap() {
  ...
  style("fill", (d, i) => {
    ...
    if (temp > 2.8 && temp < 3.9) {return "#87CEFA";} else
    if (temp >= 3.9 && temp < 5.0) {return "#73A5C6";} else
    if (temp >= 5.0 && temp < 6.1) {return "#91BAD6";} else
    if (temp >= 6.1 && temp < 7.2) {return "#BCD2E8";} else
    if (temp >= 7.2 && temp < 8.3) {return "#FFFF99";} else
    if (temp >= 8.3 && temp < 9.5) {return "#FCE486";} else
    if (temp >= 9.5 && temp < 10.6) {return "#FFA500";} else
    if (temp >= 10.6 && temp < 11.7) {return "#E3724A";} else
    if (temp >= 11.7) {return "red";}
  }).
